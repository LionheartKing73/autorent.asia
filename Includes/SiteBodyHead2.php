...
<link rel="stylesheet" href="css/bubble-tooltip.css" media="screen">
   ...
   <div id="page">
    <div id="sidebar">
      ...
      <div id="menu">
        <ul>
          <li class="first"><a href="currency_test.php">Home</a></li>

          <li>
       <form method="post" action="currency_test.php">
...
<p class="smltxtw">A minimum of 25hrs advance booking is required.
  <div align="right"> 
