...
define( 'CHECKOUT_PAGE', '2') ;   // To dtermine which Extras are to be displayed
...
<!--<form method="post" id="bookingform"  action="register_booking_waiver.php" > -->
<form method="post" id="bookingform"  action="https://autorent.asia/secure-booking-form.php" >   
