...
$Sql = "insert into locations ( locationid, location_code, location_name, location_order ) "  ;
 ...
 mysql_query( $Sql )  ;
 */
$Sql = "select * from currencies  order by currency_code";
...
<td>Code</td>
<td>Name</td>
<td align='right'>Cnv. Rate from Baht</td> 
</tr>
<?php
...
while ($row = mysql_fetch_array($ResultSet) ) {
  /*
    ...
    */
	...
	print "<td><a href='CurrencyEdit.php?Currency=".$row[ "currencies_id" ]."'>";
	print $row[ "currency_name" ];
	print "</a></td>";
        print "<td align='right'>";
    print number_format( $row[ "from_baht_rate" ], 4, ".", "," );
    print "</td>";
     print "<td align='right'><a href='CurrencyEdit.php?mode=Delete&Currency=".$row[ "currencies_id" ]."'> Delete";
...
?>
 ...
 <a href='CurrencyEdit.php?mode=Add'>Add a new Currency</a>
