<?php
/*
Replaced the code below with a simple mailing post
*/


$to = "info@autorental.asia";


$subject = "Contact us request from: ".$_REQUEST["email"];

$fromname = $_REQUEST["name"];


$subject = "Contact Us Request from Diamond Car Rental";
$message_text = "Name: ".$fromname;
