...
<form method="post" id="bookingform"  action="https://www.diamondcarrental.co.uk/DCR-secure-booking.php" >    
...
<br/>
<?php
include 'booking_costs_tablev2.php';   
...
<input type="submit" name="" value="BOOK NOW" class="button_Black" style='margin-top: 10px;'>
...
?>   
                ...
                <div class="smltxtblue" style='margin-top: 3px; text-align: left'><span style='font-weight: bold' class="smltxtblue">Exchange Rates: </span> are for illustrative purposes, your credit card will be debited for the amount of the booking deposit only and will usually be debited in the local currency except where the local currency is not accepted by our bankers when it will debited in GBP. We use the secure on-line services of PayPal to process our credit card payments.
