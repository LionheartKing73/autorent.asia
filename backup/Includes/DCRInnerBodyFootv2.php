...
?>
 ...
 // DISTRICTS
        ...
        $Sql =  "select district.*, country_subdomain from district " . 
                "JOIN country on country_id = fk_district_country_id order by district_order, district_id";
 ...
 // LOCATIONS
        ...
        $Sql =  "select locations.*, district.*, country_subdomain from locations " . 
                ...
                "JOIN country on country_id = fk_district_country_id order by district_order,district_id, location_order, location_name";
