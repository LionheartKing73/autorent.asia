...
<input type="hidden" name="poster" value="yes">
              <table align=center border=0 cellpadding="3" cellspacing="2" width="240px">
                <tbody>
				     <tr>
...
?> </td>
                                   ...
                                   <tr>
                    <td width="160" align="right" valign=top class="smltxtw">Insurance type </td>
                    <td width="298" align=left valign=top >
<?php
...
<p class="smltxtw">A minimum of 48hrs advance booking is required.
  <div align="right"> 
    ...
    <div id="content">
      ...
      <!--
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="740" height="220">
          ...
          <embed src="Movie1.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="740" height="220"></embed>
        </object>
        -->
        <img src="images/dcr_header.png" alt="Diamond Car Rental"/>
      </div>
      <div style='font-weight: bold; text-align: center; width: 100%'> 
      <img src="images/telephone.jpg" style='margin-left: 10px; float: left' alt="phone"/>
      CALL FREE FROM THE UK: 0808-120-1961. CALL FREE FROM AUSTRALIA: 1-800-789-477
      <br/>Elsewhere call +66 80 653 2255. All calls answered: 08.00-22.00hrs GMT + 07.00
      </div>
