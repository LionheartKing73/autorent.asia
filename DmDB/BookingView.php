...
include './Includes/booking_costsv4.php';
?>
<html>
<head>
...
{
	$Mode = "Edit";
	$Sql = "SELECT bookings.*, currencies.*, partner.*, vehicles.*, supplier.*, l1.location_name fromloc, l2.location_name toloc, l1.locationid, d1.district_id dist1, d2.district_id dist2 FROM bookings LEFT OUTER JOIN partner_visit on bookings.partner_visit_id = partner_visit.partner_visit_id ";
...
$Sql .= " LEFT JOIN district d1 ON d1.district_id = l1.fk_location_district_id ";  
$Sql .= " LEFT JOIN locations l2 ON l2.location_code = bookings.dropoff ";  
$Sql .= " LEFT JOIN district d2 ON d2.district_id = l2.fk_location_district_id "; 
...
<?php
    ...
    // No calc no of days
    $bc = new BookingCosts( '', 1 ,$StDateArr[2],$StDateArr[1],$StDateArr[0],$StTimeArr[0],$StTimeArr[1],$EnDateArr[2],$EnDateArr[1],$EnDateArr[0],$EnTimeArr[0],$EnTimeArr[1]);
...
elseif ( $Row["opt_child_seat"] == 1)
  $bc->OptChildSeat = 1;
    ...
    $ditfr = "-".$Row["dist2"];  
    if ( $ditto !=$ditfr  )
    	$bc->LoadOWC($ditto,$ditfr);

    $recalc_price = $bc->CalcRegionalPrice( $Row["locationid"], $ditto,$ditfr, $Row["vehicleid"], $Row["supplierid"]);
...
$sql = "select * from booking_extras be " .
    ...
    while ($Row2 = mysql_fetch_array($ResultSet) ) {
        ...
        if ( $Row2["checkout_page"] == 1)
        	$xHTML .= "<b>";
        $xHTML .=  number_format($Row2["price"],2);
        if ( $Row2["checkout_page"] == 1)
        	$xHTML .=  "</b>";
        $xHTML .=  "</td>";  
        $xHTML .=  "</tr>";  
...
<tr><td align='right'>Credit Card CVV</td><td><?php echo $Row["card_cvv"]?></td></tr>  
<tr><td align='right'>Credit Card Country</td><td><?php echo $Row["cc_country"]?></td></tr>  
<tr><td align='right'>Credit Card fname</td><td><?php echo $Row["cc_fname"]?></td></tr> 
<tr><td align='right'>Credit Card sname</td><td><?php echo $Row["cc_lname"]?></td></tr> 
<tr><td align='right'>Credit Card Add1</td><td><?php echo $Row["cc_add1"]?></td></tr> 
<tr><td align='right'>Credit Card Add2</td><td><?php echo $Row["cc_add2"]?></td></tr> 
<tr><td align='right'>Credit Card City</td><td><?php echo $Row["cc_city"]?></td></tr> 
<tr><td align='right'>Credit Card Province</td><td><?php echo $Row["cc_province"]?></td></tr> 
<tr><td align='right'>Credit Card Postcode</td><td><?php echo $Row["cc_postcode"]?></td></tr> 
<tr><td align='right'>Credit Card phone</td><td><?php echo $Row["cc_phone"]?></td></tr> 
<tr><td align='right'>Credit Card email</td><td><?php echo $Row["cc_email"]?></td></tr> 
...
<tr><td align='right'>One Way Cost</td><td align='right'><?php echo number_format( $bc->OWCprice,2 ) ?></td></tr>
<?php
...
<table><?php echo $bc->CalcString?></table
